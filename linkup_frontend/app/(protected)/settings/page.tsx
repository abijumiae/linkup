    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <header className="mb-8 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/80 dark:shadow-slate-950/20">
          ...
          <h1 className="mt-3 text-3xl font-semibold text-slate-900 dark:text-white">Account and privacy controls</h1>
        ...
        <div className="space-y-6">
          <SettingsSection title="Account settings" description="Update your email, membership, and login preferences.">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                <p className="text-sm font-semibold text-slate-900 dark:text-white">Email</p>
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">sam@linkup.design</p>
              </div>
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                <p className="text-sm font-semibold text-slate-900 dark:text-white">Member since</p>
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Jan 2025</p>
              </div>
            </div>
          </SettingsSection>
          ...
          <SettingsSection title="Profile settings" description="Customize visible information and sharing preferences.">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                ...
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Sam Wilder</p>
              </div>
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
          ...
          <SettingsSection title="Privacy settings" description="Control who can interact with you and view your activity.">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                ...
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Public</p>
              </div>
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                <p className="text-sm font-semibold text-slate-900 dark:text-white">Activity status</p>
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Visible to connections</p>
              </div>
            </div>
          </SettingsSection>
          ...
          <SettingsSection title="Notification settings" description="Manage alerts across your feed, groups, and activity.">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                ...
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Enabled</p>
              </div>
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                <p className="text-sm font-semibold text-slate-900 dark:text-white">Push alerts</p>
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Off</p>
              </div>
            </div>
          </SettingsSection>
          ...
          <SettingsSection title="Security settings" description="Update your password and protect account access.">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                <p className="text-sm font-semibold text-slate-900 dark:text-white">Trusted devices</p>
                <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">3 devices</p>
              </div>
            </div>
          </SettingsSection>
          ...
          <SettingsSection title="Language settings" description="Choose your app language and regional preferences.">
            <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">English (US)</p>
            </div>
          </SettingsSection>

          <SettingsSection title="Blocked users" description="Review and manage accounts you have blocked.">
            <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
              <p className="text-sm font-semibold text-slate-900 dark:text-white">No blocked users</p>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">You’re all clear.</p>
            </div>
          </SettingsSection>
          ...
          <SettingsSection title="Delete account" description="Remove your account and all associated data.">
            <div className="rounded-[1.5rem] border border-rose-500/20 bg-rose-500/5 p-4">
              <p className="text-sm font-semibold text-rose-700 dark:text-rose-200">Delete your account</p>
