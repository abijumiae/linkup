      ...
      <div className="mx-auto max-w-[1760px] px-4 py-6 sm:px-6 lg:px-8">
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
          <main className="space-y-6">
            <section className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-6 shadow-2xl shadow-slate-950/20 backdrop-blur-xl">
              <div className="grid gap-6 xl:grid-cols-[1fr_280px]">
                <div className="space-y-5">
                  <div className="rounded-3xl bg-gradient-to-br from-violet-500/20 via-sky-500/10 to-cyan-300/10 p-5">
                    <p className="text-sm uppercase tracking-[0.3em] text-violet-200">LinkUp</p>
                    <h2 className="mt-3 text-2xl font-semibold text-white">Connect Everything</h2>
                  ...
                  <div className="rounded-[2rem] bg-slate-950/80 p-5">
                    <div className="flex items-center gap-4 rounded-[2rem] bg-slate-900/80 p-4">
                      <div className="flex h-14 w-14 items-center justify-center rounded-3xl bg-violet-500/15 text-violet-300 text-lg font-semibold">S</div>
                      <div>
                        <p className="font-semibold text-white">Sam Wilder</p>
                ...
                <div className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-5">
                  ...
                  <div className="mt-4 grid gap-3">
                    {homeStats.map((stat) => (
                      <div key={stat.label} className="rounded-3xl bg-slate-900/80 p-4">
            ...
            <section className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 shadow-xl shadow-slate-950/20 backdrop-blur-xl">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="space-y-3">
                  <p className="text-sm uppercase tracking-[0.3em] text-violet-300/80">Daily digest</p>
                  <h1 className="text-2xl font-semibold text-white">Your social workspace is ready</h1>
                ...
                <div className="flex flex-wrap gap-3">
                  <button className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-slate-950/80 px-5 py-3 text-sm text-slate-200 transition hover:border-violet-400/40 hover:bg-white/10">
                    Latest updates
                  </button>
                  <button
                    type="button"
            ...
            <section className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 shadow-xl shadow-slate-950/20 backdrop-blur-xl">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-violet-300/80">Create post</p>
                  <h2 className="mt-3 text-xl font-semibold text-white">Share what you're building</h2>
                </div>
                <button
                  type="button"
                  onClick={handleCreatePost}
              ...
              <textarea
                ...
                className="mt-5 min-h-[120px] w-full rounded-[1.5rem] border border-white/10 bg-slate-950/80 p-4 text-sm text-slate-100 outline-none placeholder:text-slate-500"
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 text-sm text-slate-400">
                <span className="rounded-full bg-white/5 px-3 py-2">#Product</span>
                <span className="rounded-full bg-white/5 px-3 py-2">#Design</span>
                <span className="rounded-full bg-white/5 px-3 py-2">#Community</span>
              </div>
            </section>

            <section className="space-y-5 rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 shadow-xl shadow-slate-950/20 backdrop-blur-xl">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-violet-300/80">Stories</p>
                  <h2 className="mt-2 text-xl font-semibold text-white">Trending now</h2>
                </div>
                <button className="rounded-full border border-white/10 bg-slate-950/80 px-4 py-2 text-sm text-slate-200 transition hover:bg-white/5">
                  See all
                </button>
              </div>
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                {homeStories.map((story) => (
                  <div key={story.name} className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-4 text-sm shadow-2xl shadow-slate-950/10 transition hover:border-violet-500/20 hover:shadow-violet-500/10">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-3xl bg-violet-500/15 text-violet-300">{story.name[0]}</div>
                    <p className="font-semibold text-white">{story.name}</p>
                    <p className="mt-2 text-slate-400">{story.status}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 shadow-xl shadow-slate-950/20 backdrop-blur-xl">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-violet-300/80">Feed</p>
                  <h2 className="mt-2 text-xl font-semibold text-white">Explore</h2>
                </div>
                  ...
                  {homeFeedTabs.map((tab, index) => (
                    <button
                      ...
                      className={`rounded-full px-4 py-2 text-sm transition ${
                        index === 0 ? "bg-violet-500 text-slate-950" : "bg-white/5 text-slate-300 hover:bg-white/10"
                      }`}
                    >
                      {tab}
                    </button>
              ...
              <div className="mt-6 space-y-4">
                {posts.map((post) => (
                  <article key={post.id} className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 shadow-2xl shadow-slate-950/10 transition hover:border-violet-500/20 hover:shadow-violet-500/10">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex items-center gap-3">
                        <div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-violet-500/15 text-violet-300">{post.author[0]}</div>
                        <div>
                    ...
                    {post.interactionError ? (
                      <p className="mt-3 text-sm text-red-400">{post.interactionError}</p>
                    ) : null}
                    {post.showComments ? (
          ...
          <aside className="space-y-6 rounded-[2rem] border border-white/10 bg-slate-900/80 p-6 shadow-2xl shadow-slate-950/20 backdrop-blur-xl">
            <div className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-violet-300/80">Trending</p>
                  <h2 className="mt-2 text-xl font-semibold text-white">Topics</h2>
                </div>
                <TrendingUp className="h-5 w-5 text-violet-300" />
              </div>
              <div className="mt-4 space-y-3">
                {homeTrendingTopics.map((topic) => (
                  <div key={topic} className="rounded-[2rem] border border-white/10 bg-slate-950/80 px-4 py-3 text-sm text-slate-300">
                    {topic}
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-violet-300/80">Suggested</p>
                  <h2 className="mt-2 text-xl font-semibold text-white">People to follow</h2>
                </div>
                <UserPlus className="h-5 w-5 text-violet-300" />
              </div>
              <div className="mt-4 space-y-3">
                {homeSuggestions.map((name) => (
                  <div key={name} className="flex items-center justify-between rounded-[2rem] border border-white/10 bg-slate-900/80 px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-[2rem] bg-violet-500/15 text-violet-300">{name[0]}</div>
                      <div>
                        <p className="font-semibold text-white">{name}</p>
                        <p className="text-xs text-slate-500">Active creator</p>
                      </div>
                    </div>
                    <button className="rounded-full bg-white/5 px-3 py-1 text-xs text-slate-300 transition hover:bg-white/10">Follow</button>
                  </div>
                ))}
              </div>
            </div>
            <div className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-violet-300/80">Online</p>
                  <h2 className="mt-2 text-xl font-semibold text-white">Friends</h2>
                </div>
              </div>
              <div className="mt-4 grid gap-3">
                {homeOnlineFriends.map((friend) => (
                  <div key={friend} className="rounded-[2rem] border border-white/10 bg-slate-950/80 px-4 py-3 text-sm text-slate-300">
                    {friend}
                  </div>
                ))}
              </div>
