  ...
  return (
    <div className="linkup-auth-shell bg-gradient-to-br from-slate-50 via-white to-brand-primary/5 text-slate-900 dark:from-brand-dark dark:via-brand-dark dark:to-brand-dark dark:text-white">
      ...
      <div className="linkup-panel relative w-full max-w-md p-7 text-slate-900 dark:text-white sm:max-w-lg sm:p-8">
        ...
        {/* Heading */}
        <h1 className="text-center text-2xl font-semibold tracking-tight text-brand-text dark:text-brand-light">Create your LinkUp account</h1>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block space-y-2">
              ...
              <select
                className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 outline-none transition focus:border-brand-primary/60 dark:border-white/10 dark:bg-brand-dark/70 dark:text-white dark:focus:border-brand-primary/50"
                value={accountType}
        ...
        <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
          ...
          <Link href="/login" className="font-semibold text-brand-primary transition hover:text-brand-primary dark:text-brand-secondary dark:hover:text-brand-secondary">
            Login
          </Link>
        </p>
      </div>
