...
export default function ProfileTabs({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-3 shadow-lg shadow-slate-950/5 dark:border-white/10 dark:bg-brand-dark/80 dark:shadow-slate-950/20 sm:p-4">
