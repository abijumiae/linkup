    ...
    <button
      ...
      className={`flex w-full items-start justify-between rounded-[1.75rem] border p-4 text-left transition duration-300 ${
        active
          ...
          : "border-white/10 bg-slate-950/85 hover:-translate-y-0.5 hover:border-violet-400/30 hover:bg-white/5"
      }`}
    >
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-sm text-slate-400">{lastMessage}</p>
        </div>
      </div>
