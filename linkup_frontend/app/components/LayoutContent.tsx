...
export default function LayoutContent({
  ...
  return (
    <>
      ...
      >
        {showNavigation && (
          <aside className="hidden w-[260px] shrink-0 border-r border-slate-200/90 bg-gradient-to-b from-white via-white to-slate-50/90 p-3 lg:block lg:w-[280px] lg:p-4 lg:py-6 dark:border-white/10 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900/80">
