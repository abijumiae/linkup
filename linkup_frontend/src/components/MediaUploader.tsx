    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className="inline-flex min-h-[44px] items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:border-brand-primary/30 hover:bg-brand-primary/5 disabled:cursor-not-allowed disabled:opacity-60 dark:border-white/10 dark:bg-brand-dark/70 dark:text-slate-200 dark:hover:bg-brand-primary/10"
        >
          {isUploading ? (
